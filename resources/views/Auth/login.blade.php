            ...
            loginForm.on('submit', function(event) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            toastr.success(response.message || 'Login berhasil, mengalihkan ke dashboard...');
                            setTimeout(function() {
                    ...
                    error: function(xhr) {
                        ...
                        let errors = xhr.responseJSON.errors || { general: ['Terjadi kesalahan. Silakan coba lagi.'] };
                        if (errors.general) {
                            toastr.error(errors.general[0]);
                        } else {
